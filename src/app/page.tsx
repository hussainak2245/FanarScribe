  ...
  return (
    <div className="bg-white text-zinc-950">
        ...
        <div className="mx-auto flex h-12 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link
              ...
              className="border-2 border-accent-500 bg-accent-500 px-3 py-1 font-mono text-xs font-bold uppercase tracking-wider text-white transition-colors hover:bg-accent-600 hover:border-accent-600"
            >
              Open →
            </Link>
          </div>
      ...
      <main>
            ...
            <div className="flex items-end justify-between gap-8">
              <div className="flex-1">
                ...
                <p className="mt-5 font-mono text-base font-bold uppercase tracking-widest text-zinc-950 sm:text-xl">
                  Focus on the patient, not the documentation.
                </p>
                ...
                <div className="mt-8 flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                  <Link
                    href={routes.doctorDashboard}
                    className="inline-block border-2 border-accent-500 bg-accent-500 px-5 py-2.5 font-mono text-sm font-bold uppercase tracking-wider text-white transition-all hover:bg-accent-600 hover:border-accent-600 hover:translate-y-[-2px]"
                  >
                    Open demo workspace →
                  </Link>
                  <a
                    href="#demo"
                    className="inline-block border-2 border-zinc-300 px-5 py-2.5 font-mono text-sm font-bold uppercase tracking-wider text-zinc-500 transition-all hover:border-accent-500 hover:text-accent-500"
                  >
                    See the demo ↓
                  </a>
                </div>
              ...
              <div className="hidden flex-shrink-0 flex-col items-end gap-3 lg:flex">
                <Image
                  ...
                  priority
                />
                <div className="border-2 border-accent-500 bg-accent-500 px-3 py-1.5">
        ...
        {/* ── 02 PROBLEM ── */}
        <section id="problem" className="border-b-2 border-zinc-950 bg-accent-500 px-4 py-12 sm:px-6 sm:py-16">
          <div className="mx-auto max-w-6xl">
            <p className="font-mono text-xs font-bold text-white/60">02 / THE PROBLEM</p>
            <div className="mt-6 border-2 border-white/30 p-6">
              <p className="font-mono text-5xl font-bold text-white sm:text-6xl">20–40</p>
              <p className="mt-2 font-mono text-xs uppercase tracking-widest text-white/60">minutes per consultation</p>
              <p className="mt-3 text-sm text-white/80">lost to documentation instead of the patient.</p>
            </div>
        ...
        <section className="border-b-2 border-zinc-950 px-4 py-12 sm:px-6 sm:py-16">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-0">
              ...
              {/* Left: the problem — vertically stacked */}
              <div className="border-2 border-zinc-950 p-6 sm:p-8 lg:border-r-0">
                ...
                <div className="mt-5 flex flex-col border-2 border-zinc-950">
                  {["Chest tightness", "Shortness of breath", "Both"].map((m, i, arr) => (
                    <div
                      key={m}
                      className={`p-3 ${i < arr.length - 1 ? "border-b-2 border-zinc-950" : ""}`}
                    >
                      <p className="font-mono text-xs font-bold text-zinc-950">{m}</p>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-8 space-y-0 border-2 border-zinc-950">
                  {[
                    ...
                    <div key={n} className={`flex gap-4 p-4 ${i < arr.length - 1 ? "border-b-2 border-zinc-950" : ""}`}>
                      <span className="flex-shrink-0 font-mono text-sm font-bold tabular-nums text-zinc-300">{n}</span>
                      <div>
        ...
        {/* ── 04 HOW IT WORKS ── */}
        <section id="how" className="border-b-2 border-zinc-950 bg-accent-500 px-4 py-12 sm:px-6 sm:py-16">
          <div className="mx-auto max-w-6xl">
            <p className="font-mono text-xs font-bold text-white/60">04 / SYSTEM</p>
            <h2 className="mt-4 text-2xl font-bold text-white sm:text-3xl">
              What Sajil actually does.
            </h2>
            <div className="mt-8 grid gap-px border-2 border-accent-400 bg-accent-400 grid-cols-2 sm:grid-cols-4">
              {[
                ...
                <div key={label} className="bg-white p-4 sm:p-5">
                  <p className={`font-mono text-xs font-bold uppercase tracking-wider ${accent ? "text-accent-500" : "text-zinc-400"}`}>
                    {label}
                  </p>
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
              <div>
                ...
                <div className="mt-6 space-y-2 border-l-4 border-zinc-200 pl-4">
                  {[
                    "Patient speaks",
                    ...
                    <div key={i} className="flex items-center gap-3">
                      <span className="w-3 font-mono text-[10px] font-bold tabular-nums text-zinc-300">{i + 1}</span>
      ...
      {/* ── FOOTER ── */}
      <footer className="border-t-2 border-accent-500 px-4 py-4 sm:px-6">
